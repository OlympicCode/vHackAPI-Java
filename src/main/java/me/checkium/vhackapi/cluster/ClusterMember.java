...
public class ClusterMember {
    ...
    private String username, lastactive;
    private ClusterRank rank;
    private int score, reps, userid;
    ...
    public ClusterMember(JSONObject memberData) {
        ...
        switch (rank) {
            case 1: {
                this.rank = ClusterRank.MEMBER;
                break;
            }
            case 2: {
                this.rank = ClusterRank.COLEADER;
                break;
            }
            case 3: {
                this.rank = ClusterRank.LEADER;
                break;
            }
            default:{
                this.rank = null;
